...
ggplot(track_part_final) + geom_density(aes(danceability)) + geom_density(aes(energy)) + geom_density(aes(loudness)) + geom_density(aes(speechiness)) + geom_density(aes(acousticness)) + geom_density(aes(instrumentalness))
#ACABR ESTO, AUN NO SE VE BIEN Y PEUDE QUE NECESITE DIVIDIR LAS GRAFICAS.
```
